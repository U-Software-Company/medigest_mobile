...
class ReturnScreen:
    ...
    def _switch_view(self, view_name: str):
        ...
        # Reconstruire la sidebar pour mettre à jour le style
        self._rebuild_sidebar()
    
    def _rebuild_sidebar(self):
        """Reconstruit la sidebar avec le bon élément actif"""
        # Trouver la Row principale et remplacer la sidebar
        # Pour simplifier, on recharge tout l'écran
        self.show()
    ...
    def load_invoices(self):
        ...
        try:
            with self.db.get_connection() as conn:
                ...
                query = """
                    SELECT 
                        s.id, s.invoice_number, s.customer_name, s.total_amount, 
